...
- 💻 [Desktop optimization](https://github.com/wswmsword/chao-mobile-forever) - the mobile area
...
- [chao-mobile-forever](https://github.com/wswmsword/chao-mobile-forever) - To adapt different displays by one mobile viewport
