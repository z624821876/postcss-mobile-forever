...
module.exports.remakeExtractedGetLocalIdent = function({ defaultGetLocalIdent, getLocalIdent }) {
  return (context, localIdentName, localName, options) => {
    ...
    const aStr = __dirname.replace(process.cwd(), ''); // '/node_modules/chao-mobile-forever'
    const bStr = resourcePath.replace(aStr + '/.temp', ''); // remove '/node_modules/chao-mobile-forever/.temp'
